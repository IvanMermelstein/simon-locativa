...
const COLORS: ColorDef[] = [
  { id: 0, name: "Rojo", baseFrom: "#c04545", baseTo: "#5a1010", litFrom: "#ffb3b3", lit: "#ef4444", glow: "rgba(239,68,68,0.9)", logo: wedge1, logoBg: "#ffffff", logoPad: 8 },
  { id: 1, name: "Verde", baseFrom: "#3c9e63", baseTo: "#0c3a1e", litFrom: "#a7f3d0", lit: "#22c55e", glow: "rgba(34,197,94,0.9)", logo: wedge2, logoBg: "#ffffff", logoPad: 8 },
  { id: 2, name: "Azul", baseFrom: "#4a7fc9", baseTo: "#10294d", litFrom: "#bfdbfe", lit: "#3b82f6", glow: "rgba(59,130,246,0.9)", logo: wedge3, logoBg: "#ffffff", logoPad: 8 },
  { id: 3, name: "Amarillo", baseFrom: "#cfa52e", baseTo: "#4f3f06", litFrom: "#fef08a", lit: "#eab308", glow: "rgba(234,179,8,0.9)", logo: wedge4, logoBg: "#ffffff", logoPad: 8 },
  { id: 4, name: "Violeta", baseFrom: "#9256cf", baseTo: "#2e0e4f", litFrom: "#e9d5ff", lit: "#a855f7", glow: "rgba(168,85,247,0.9)", logo: wedge5, logoBg: "#ffffff", logoPad: 8 },
  { id: 5, name: "Naranja", baseFrom: "#d97a35", baseTo: "#4f2006", litFrom: "#fed7aa", lit: "#f97316", glow: "rgba(249,115,22,0.9)", logo: wedge6, logoBg: "#ffffff", logoPad: 8 },
]
    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-gradient-to-br from-[#0B2558] to-black">
      <div className="w-full max-w-2xl">
        ...
        <div className="text-center mb-4">
          <div className="relative w-[500px] h-[263px] mx-auto my-2 overflow-hidden">
            <Image
              src={cabeceraSimon}
              fill
              priority
